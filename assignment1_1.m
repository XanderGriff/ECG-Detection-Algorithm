...
[peaksFirst10s,locationsFirst10s,processedQRSData] = qrsTiming(data_10s,time_10s);
...
subplot(2,1,2)       
plot(time_10s,processedQRSData,locationsFirst10s,peaksFirst10s,'or'); 
...
[peaksLast10s,locationsLast10s,processedQRSData] = qrsTiming(data_Last10s,time_Last10s);
...
subplot(2,1,2)       
plot(time_Last10s,processedQRSData,locationsLast10s,peaksLast10s,'or');
